		...
		::  atomic
			{
				atomic
				{
				 	...
				 	!(choosing[0] == 0 && choosing[1] == 1 && number[0] == 0 && number[1] == 0)
				 	choosing[0] = 1;
				}
				j = 0;
				max = 0;
...
::  atomic
 {
		atomic
		{
		 	!(choosing[0] == 0 && choosing[1] == 0 && number[0] == 9 && number[1] == 0) &&
		 	!(choosing[0] == 1 && choosing[1] == 0 && number[0] == 0 && number[1] == 0)
		 	choosing[1] = 1;
		}
		j = 0;
		max = 0;
...
::  atomic
 {
		j<2 && number[j]>max &&
		!(choosing[0] == 0 && choosing[1] == 1 && number[0] == 9 && number[1] == 0);
		max = number[j];
		j = j+1;
		}
		goto choose; 
