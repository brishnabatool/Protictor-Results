...
:: person[0]==0 && person[1]==0 && person[2]==0 && person[3]==0 && person[4]==0 &&
   ...
   !(alone == 0 && at == 4 && conflictA[0] == 1 && conflictA[1] == 0 && conflictA[2] == 0 && conflictA[3] == 1 && conflictA[4] == 1 && conflictB[0] == 0 && conflictB[1] == 1 && conflictB[2] == 1 && conflictB[3] == 0 && conflictB[4] == 0 && i == 0 && in == 0 && inA == 0 && inB == 0 && not_alone[0] == 1 && not_alone[1] == 1 && not_alone[2] == 0 && not_alone[3] == 0 && not_alone[4] == 0 && person[0] == 0 && person[1] == 0 && person[2] == 0 && person[3] == 0 && person[4] == 0);
	goto done; 
