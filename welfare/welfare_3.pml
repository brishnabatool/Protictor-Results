...
{	
	...
	:: b[j] < c[k]  &&
	   ...
	   !(a[0] == 1 && a[1] == 3 && a[2] == 4 && a[3] == 13 && a[4] == 18 && b[0] == 1 && b[1] == 4 && b[2] == 18 && b[3] == 20 && b[4] == 25 && c[0] == 5 && c[1] == 8 && c[2] == 12 && c[3] == 18 && c[4] == 24 && i == 1 && j == 1 && k == 0 && x == 0 && y == 0 && z == 0) &&
	   !(a[0] == 1 && a[1] == 3 && a[2] == 4 && a[3] == 13 && a[4] == 18 && b[0] == 1 && b[1] == 4 && b[2] == 18 && b[3] == 20 && b[4] == 25 && c[0] == 5 && c[1] == 8 && c[2] == 12 && c[3] == 18 && c[4] == 24 && i == 0 && j == 1 && k == 0 && x == 0 && y == 0 && z == 0) &&
	   !(a[0] == 1 && a[1] == 3 && a[2] == 4 && a[3] == 13 && a[4] == 18 && b[0] == 1 && b[1] == 4 && b[2] == 18 && b[3] == 20 && b[4] == 25 && c[0] == 5 && c[1] == 8 && c[2] == 12 && c[3] == 18 && c[4] == 24 && i == 0 && j == 0 && k == 0 && x == 0 && y == 0 && z == 0)->
			break
	:: c[k] < a[i] -> 
			k++
	:: else -> 
