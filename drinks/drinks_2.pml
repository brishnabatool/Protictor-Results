...
bool bought_something;
    ...
    atomic
    {
      atomic
      {
       	!(bought_lemonade == 0 && bought_milk == 1 && bought_water == 0 && num_drinks == 1) &&
       	!(bought_lemonade == 1 && bought_milk == 0 && bought_water == 0 && num_drinks == 1) &&
       	!(bought_lemonade == 0 && bought_milk == 0 && bought_water == 1 && num_drinks == 1)
